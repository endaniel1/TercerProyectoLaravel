...
<div class="header">
			...
			<div class="header-info">
				...
				@if(session()->has("mensaje_no_autenticado"))
				<div class="alert alert-info">
					{{session("mensaje_no_autenticado")}}
				</div>
				@endif				
				{!! Form::open(["route"=>"login","method"=>"POST"]) !!}

				 <div class="form-group{{ ($errors->has('password') || $errors->has('name') ) ? ' has-error' : '' }}"> 
					...
					<table class="table table-condensed" >
						<tr>
							...
							<td>
								{!! Form::text("name",old('name'),["class"=>"form-control","placeholder"=>"Nombre de Usuario"]) !!}
								@if ($errors->has('name'))
						...
						<tr>
							<td>
								{!! Form::button("Iniciar",["type"=>"submit","class"=>"btn btn-primary btn-sm"])!!}
							</td>
							<td>
